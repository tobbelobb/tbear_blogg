...
saxon-xslt 2026/2026.xml blogtemplate.xsl > 2026/index.html
...
# Let the main page be a copy of the 2026 page for now
cp 2026/index.html index.html
# The new index should point to itself without the 2026 part
sed -i 's/<meta property="og:url" content="https:\/\/torbjornludvigsen.com\/blog\/2026/<meta property="og:url" content="https:\/\/torbjornludvigsen.com\/blog/g' index.html
# Remove the "this is 2026" part for front page blog version
sed -i 's/Reprap Blog 2026//g' index.html
