...
# Let the main page be a copy of the 2021 page for now
cp 2021/index.html index.html
# All references to the bilder directory should point to 2021/bilder
sed -i 's/="\.\/bilder/="bilder/g' index.html
sed -i 's/="bilder/="2021\/bilder/g' index.html
# All references to ../../ should point to ../
sed -i 's/href=\"\.\.\/\.\.\//href="\.\.\//g' index.html
# The new index should point to itself without the 2021 part
...
# Remove the "this is 2021" part for front page blog version
sed -i 's/Reprap Blog 2021//g' index.html
